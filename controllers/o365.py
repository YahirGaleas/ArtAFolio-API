...
from utils.security import generate_pkce_challenge, generate_pkce_verifier
...
async def auth_callback_o365(request: Request):
    ...
    token_data = {
        ...
        "redirect_uri": redirect_uri,
        "code_verifier": pkce,
        "client_secret": client_secret  # Agregar el client_secret aquí
    }
